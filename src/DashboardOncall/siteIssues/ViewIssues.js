...
const ViewIssues = () => {
    ...
    return (
        <div className='bg-blue-200'>
            {
                issues?.length=== 0 ? (<div className='rounded-lg'>
                    <h2 className='text-center text-xl text-green-600 py-2 '> Wow ! No Pending Issue Right Now .</h2>
                </div>) 
                 :
                            ...
                            issues?.map((issue, index) => (
                                <tr className='border border-slate-300'>
                                    <th className='border border-slate-300'>
                                        <label
                                        htmlFor="my_modal_6"
                                         className='btn btn-md btn-square  btn-outline' 
